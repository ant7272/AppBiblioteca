        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="mb-4">
                            <label class="form-label" for="Fecha_Publicacion">Fecha_Publicacion</label>
                            <input type="text" class="form-control js-flatpickr" id="Fecha_Publicacion" name="Fecha_Publicacion" value="<?= set_value('', $reward['Fecha_Publicacion']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="Edicion" name="Edicion" value="<?= $reward['Edicion'] ?>">
                            </div>
                        </div>
